#' Calculate puckR expected goals (xG)
#'
#' @description Uses the puckR expected goals model to calculate xG for any pbp data frame generated by puckR
#'
#' @param pbp A play-by-play data frame, previously returned by puckR::scrape_game
#'
